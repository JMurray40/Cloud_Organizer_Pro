...
const PROVIDERS: Record<string, ProviderMeta> = {
  ...
  pcloud: {
    ...
    // Actual token URL is region-specific (US vs EU) — determined at callback time from locationid param
    tokenUrl: "https://api.pcloud.com/oauth2_token",
    // pCloud grants full access without scopes
    scopes: [],
  ...
  koofr: {
    ...
    defaultUsedGb: 0,
    rootPath: "/",
    // Koofr supports OAuth 2.0 but requires developer registration — manual tracking for now
    connectMode: "manual-only",
    authUrl: "",
    tokenUrl: "",
    scopes: [],
  ...
  idrive: {
    ...
    defaultUsedGb: 0,
    rootPath: "/",
    // IDrive personal backup OAuth is dormant for new apps — manual tracking
    connectMode: "manual-only",
    authUrl: "",
    tokenUrl: "",
    scopes: [],
  ...
  nordlocker: {
    ...
    defaultUsedGb: 0,
    rootPath: "/",
    // NordLocker has no public API — manual tracking only
    connectMode: "manual-only",
    authUrl: "",
    tokenUrl: "",
    scopes: [],
  ...
  proton_drive: {
    ...
    defaultUsedGb: 0,
    rootPath: "/",
    // Proton Drive uses proprietary SRP auth with E2E encryption; no public OAuth API
    connectMode: "manual-only",
    authUrl: "",
    tokenUrl: "",
    scopes: [],
  ...
  icedrive: {
    ...
    defaultUsedGb: 0,
    rootPath: "/",
    // IceDrive has no public third-party API — manual tracking only
    connectMode: "manual-only",
    authUrl: "",
    tokenUrl: "",
    scopes: [],
  ...
  sync_com: {
    ...
    defaultUsedGb: 0,
    rootPath: "/",
    // Sync.com has no public third-party API — manual tracking only
    connectMode: "manual-only",
    authUrl: "",
    tokenUrl: "",
    scopes: [],
