...
export const namingRulesTable = pgTable(
  "naming_rules",
  {
  ...
  (t) => [index("naming_rules_user_idx").on(t.userId)],
);

export const insertNamingRuleSchema = createInsertSchema(namingRulesTable).omit({ id: true, userId: true, createdAt: true });
